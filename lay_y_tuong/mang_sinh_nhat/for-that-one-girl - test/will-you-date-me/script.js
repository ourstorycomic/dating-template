document.addEventListener('DOMContentLoaded', function() {
    ...
    const noBtnResponses = [
        ...
        "Cơ hội cuối cùng...",
        "Làm ơn đi mà?",
        "Có lẽ bạn đang nhấn nhầm nút",
        "Bạn đang làm tan vỡ trái tim mình!",
        "Thôi nào...",
        "Đừng ngại!",
        "Không hay chút nào!",
        "Ý bạn là có phải không?",
        "Thử lại nhé?",
        "Mình vẫn đang chờ...",
        "Xem xét lại đi mà!",
        "Bạn bỏ lỡ nút đồng ý kìa!",
        "Có thể bạn nhấn nhầm?",
        "Cho thêm một cơ hội nữa nhé?",
        "Còn bây giờ thì sao?",
        "Đổi ý chưa?",
        "Người đáng yêu ơi, mình biết bạn sẽ nói đồng ý mà!",
        "Nói đồng ý đi nào!"
    ];
